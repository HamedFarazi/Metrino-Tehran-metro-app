  ...
  return (
    <div className={cn("relative block md:hidden", className)}>
            ...
            {items.map((item, idx) => (
              ...
              >
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-card border border-border shadow-lg"
                >
      ...
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full bg-card border border-border shadow-lg"
      >
        <IconLayoutNavbarCollapse className="h-5 w-5 text-foreground/60" />
      </button>
    </div>
  );
};
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_8px_32px_rgba(0,0,0,0.5)]",
        className
      )}
    >
      {items.map((item) => (
